...
public class AvailabilityService {
    ...
    public List<Availability> getFilteredSlots(String date, Long stylistId, List<Long> serviceIds) {
        return availabilityRepo.findByDateAndStylistAndServices(date, stylistId, serviceIds);
    }

    public List<String> findNextAvailableDates(String fromDate, Long stylistId, List<Long> serviceIds) {
        return availabilityRepo.findAvailableDatesAfter(fromDate, stylistId, serviceIds)
                .stream()
                .limit(3)
